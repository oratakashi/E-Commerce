		...
		<div class="container">
			...
			<?php if(empty($_GET['other'])){ ?>
				<div class="bo9 p-l-40 p-r-40 p-t-30 m-t-30 col-md-12">
					...
					<?php 
						...
						$connection = new ConnectionDB();
						$conn = $connection -> getConnection();
						$sql = "SELECT * from tmp_pengiriman where id_cart = '$id'";
						$query = $conn->prepare($sql);
						$query->execute();
						
						foreach($query as $pengiriman){}
					?>
					<a href="" style="float:right"><button><i class="fa fa-pencil"></i> Ubah</button></a>
					...
					<a href="store.php?page=cart&other=yes"><button class="btn btn-primary col-md-12">Kirim ke Alamat Lain</button></a>
				</div>
			<?php }elseif(isset($_GET['other'])){?>
				<div class="bo9 p-l-40 p-r-40 p-t-30 m-t-30 col-md-12">
					...
					<form action="aksi/ubah_pengiriman.php" method="post">
					<div class="flex-w flex-sb-m p-b-12">
						<span class="s-text18 w-size19 w-full-sm">
							Penerima:
						</span>
						...
						<span class="m-text21 w-size20 w-full-sm">
							<input type="text" name="penerima" id="" placeholder="Tambahkan Penerima">
						</span>
					</div>
					<div class="flex-w flex-sb-m p-b-12">
						<span class="s-text18 w-size19 w-full-sm">
						...
						<span class="m-text21 w-size20 w-full-sm">
							<input type="text" name="alamat" id="" placeholder="Tambahkan Alamat">
						</span>
					</div>
					<div class="flex-w flex-sb-m p-b-12">
						<span class="s-text18 w-size19 w-full-sm">
						...
						<span class="m-text21 w-size20 w-full-sm">
							<input type="text" name="no_hp" id="" placeholder="Tambahkan Telp">
						</span>
						<input type="submit" name="gantiPengirim" style="margin-top:10px" class="btn btn-primary col-md-12" value="Simpan">
					</div>
