<div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h3 class="text-primary">Lihat Daftar Barang</h3> </div>
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                        <li class="breadcrumb-item active">Lihat Daftar Barang</li>
                    </ol>
                </div>
            </div>
            <!-- End Bread crumb -->
            ...
            <div class="container-fluid">
                ...
                <div class="row justify-content-center">
                    ...
                    <?php
                            ...
                            $sql = "SELECT * from tb_produk p INNER JOIN tb_kategori g where p.id_kategori=g.id_kategori";
                            $hasil = $conn->prepare($sql);
                            $hasil->execute();
                    ?>
                        <div class="card">
                            <div class="card-title">
                                <center><h4>Daftar Barang </center></h4>
                            </div>
                            <div class="card-body">
